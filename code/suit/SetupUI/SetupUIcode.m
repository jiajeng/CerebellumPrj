classdef SetupUIcode < matlab.apps.AppBase
    ...
    methods (Access = private)
        function InitialVar(app,varargin)
            ...
            if ~isempty(o)
                ...
                app.AnaSourceEditField.Value = o.conn_AnaSource;
                % roi path
        ...
        function [f,o] = SetupVar(app)
            ...
            o.conn_AnaSource = app.AnaSourceEditField.Value;
            % roi path
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.BehaveFileinfoPanel.Position = [6 215 178 105];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = SetupUIcode(varargin)
            if ~nargin
                f = [];
                o = [];
            end
